...
@Component({
  selector: 'app-edit-cust-master',
  templateUrl: './edit-cust-master.component.html',
  styleUrls: ['./edit-cust-master.component.scss']
})
export class EditCustMasterComponent     implements OnInit{
...
ngOnInit(): void {
  this.id = this.url.snapshot.params['id'];
    ...
    console.log(this.id);
     this.studentservice.singlecustomer(this.id).subscribe(data =>{
...
onSubmit(){
  ...
  this.studentservice.updatecustomer(this.id,this.addcustomer.value).subscribe((data:any)=>{
    console.log(data);
